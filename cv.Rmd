...
headcolor: 990000
aboutme: "I am a data scientist passionate about modelling data using latest technologies and multicloud solutions.
My focus is on hands on experience with variety of tools rather than management, although I have experience in team management in both startups and corporate companies. I am a total AI and E/ACC freak."
docname: CV
...
- **Multicloud Experience:** Skilled in handling data from AWS, GCP, Databricks, and creating reports using dashboards and insights.
...
tribble(
    ...
    "Head of Research and Analytics", "Warsaw", "3", "2020", 12, "2021", "Drogerie Natura", "Predictions of new shop revenue",  
    ...
    "Head of Analytics", "Zielona Góra", "1", "2019", 10, "2019", "eobuwie.pl", "Segmentations of customers and shops",
    ...
    "Assistant", "Warsaw", NA, "2005", NA, "2009", "Institute of Applied Social Sciences at The University of Warsaw", "TECHNOLOGIES: R, SPSS",
...
```{r}
tribble(~title, ~where, ~details, ~authors,
        "Comment classification for Internet auction platforms", "Lecture Notes in Computer Science 5739, Springer", "2009, pp. 129-137","T. Kaszuba, A. Wierzbicki, A. Hupa",
        "Interdisciplinary Matchmaking: Choosing Collaborators by Skill, Acquaintance and Trust", "A. Abraham, A. Hassanien, V. Snasel (eds.) Computational Social Network Analysis. Trends, tools, and research advances, Springer", " pp. 319-348","A. Hupa, K. Rządca, A. Wierzbicki and A. Datta", 
        "Badania orientacji politycznych w Internecie", "Studia socjologiczne", "3/2007","A. Hupa"
        ) %>% 
    detailed_entries(
    with = title,
    what = glue::glue("{where} {details}"),
    #why = ,
    when = authors
    #when = glue::glue("{startMonth} {startYear} - {endMonth} {endYear}", .na = ""),
    #where = where
